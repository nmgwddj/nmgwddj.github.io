...
同虚拟内存一样，堆内存也可以遍历得到每一块堆内存的使用情况，主要用到的就是 `HeapWalk` 函数，下面的图片介绍了不同堆类型的不同属性值，图片下面是代码实现，参考者图看代码更容易理解。 [![2016-04-10_185012](http://www.mycode.net.cn/wp-content/uploads/2016/04/2016-04-10_185012.png)](http://www.mycode.net.cn/wp-content/uploads/2016/04/2016-04-10_185012.png)
